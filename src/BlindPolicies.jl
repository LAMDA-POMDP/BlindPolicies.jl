...
POMDP solver for solving a blind policy, which takes the same action regardless of the observations it receives.
The value of blind policy constitutes a useful lower bound of the optimal value.
"""
